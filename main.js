...
function elegirPalabra() {
    let palabras = [
        ...
        { nombre: "Televisión", descripcion: "Dispositivo utilizado para recibir y mostrar imágenes y sonidos." }
        ...
        { nombre: "Ingeniero", descripcion: "Creativo que fusiona ciencia y tecnología para resolver problemas prácticos, desde la creación de estructuras hasta la mejora de procesos." },
        { nombre: "Profesor", descripcion: "Guía del conocimiento que siembra ideas, habilidades y valores, motivando a sus estudiantes a explorar nuevas posibilidades." },
        { nombre: "Arquitecto", descripcion: "Creador de espacios funcionales y estéticamente agradables, que diseña no solo estructuras, sino el entorno en el que las personas vivirán." },
