...
let palabra = objetoPalabra.nombre;
let descripcion = objetoPalabra.descripcion;
let descripcionPalabra = document.querySelector(".descripcionPalabra");
descripcionPalabra.textContent = descripcion;
